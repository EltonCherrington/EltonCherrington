# Free, self-contained web tools

No servers, no signups, no trackers. Every tool ships as one static file you
can keep forever — and costs **$0**, always. A voluntary **USDC on Base** tip
keeps them up. No gate, no paywall, ever.
...
- [**72 hours unattended: the memory bugs that broke my autonomous coding agent**](https://eltoncherrington.github.io/memctl-shop/essay.html) — an honest field report on what happens when an autonomous agent loses its memory mid-run.

## Tip lane

Every tool is free. If one saved you work, thank it with a small **USDC** transfer on **Base**
(canonical Circle USDC): `0x648bAa08901f1bEAB002Af57f1375F80Ec4F4893`.
A receipt page with on-chain verification ledger: [micro.plainqr.io-equivalent](https://eltoncherrington.github.io/memctl-shop/micro.html)